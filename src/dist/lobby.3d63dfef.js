...
var disabledButton = document.getElementById('startGame'); //socket
//const socket = io('http://localhost:3001')

var socket = (0, _socket.io)('http://66.71.53.162:3001');
socket.on("connect", function () {
  console.log('You connected with id: ${socket.id}'); //get locally stored value of isHost
...
socket.on("room-not-exists", function (message) {
  console.log(message);
});
socket.on("created-room", function (message) {
  console.log(message);
});
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/lobby.js"], null)
//# sourceMappingURL=/lobby.3d63dfef.js.map